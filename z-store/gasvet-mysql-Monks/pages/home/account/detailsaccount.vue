      ...
      <div class="deatails-account-inside">
        <div class="daii">
          ...
          <ul class="daiul">
            ...
            <li class="daili">
              <span>Giriş</span>
              <span><span>{{activeInfo.activeamount | currency('₺',0)}}</span></span>
            </li>
            <li class="daili">
              <span>Kazanç</span>
              <span><span>{{activeInfo.activeearn | currency('₺',0)}}</span></span>
            </li>
          </ul>
        </div>
        <div class="daii">
          ...
          <ul class="daiul">
            ...
            <li class="daili">
              <span>Giriş</span>
              <span>{{wonInfo.wonamount | currency('₺',0)}}</span>
            </li>
            <li class="daili">
              <span>Ödenen</span>
              <span>{{wonInfo.wonearn | currency('₺',0)}}</span>
            </li>
            <li class="daili">
              <span>Zarar</span>
              <span>{{wonDiff | currency('₺',0)}}</span>
            </li>
          </ul>
        </div>
        <div class="daii">
          ...
          <ul class="daiul">
            ...
            <li class="daili">
              <span>Giriş</span>
              <span>{{lostInfo.wonamount | currency('₺',0)}}</span>
            </li>
            <li class="daili">
              <span>Kazanılan</span>
              <span>{{lostInfo.wonamount | currency('₺',0)}}</span>
            ...
            <li class="daili">
              <span>Kutarılan</span>
              <span>{{lostInfo.wonearn | currency('₺',0)}}</span>
            </li>
          </ul>
        </div>
        <div class="daii">
          ...
          <ul class="daiul">
            ...
            <li class="daili">
              <span>Giriş</span>
              <span>{{totalInfo.totalamount | currency('₺',0)}}</span>
            </li>
            <li class="daili">
              <span>Sonuç</span>
              <span>{{totalResult | currency('₺',0)}}</span>
            </li>
          </ul>
        </div>
      </div>
