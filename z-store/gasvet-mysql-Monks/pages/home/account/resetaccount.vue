<template>
  <div class="pages">
    <header class="title-2" id="content">
      <span>HESAP KESİMİ</span>
      <select v-if="checkA2" v-model="userBox" class="selectbox box-account" @change="getResetInfo()">
      ...
      <form class="reg-form">
        ...
        <div class="resetaccount-items" v-if="checkEarn">
          ...
          <span>
            ...
            <span v-if="checkA2 && !done" class="badge bg-f"  @click="updateComission()">Kaydet</span>
