  ...
  <div v-if="checkRole" class="pages">
    ...
    <div class="account-con">
      ...
      <form class="reg-form" @submit.prevent="register">
        ...
        <div v-if="checkA2" class="reg-rows">
        ...
        <div v-if="!checkA2 && !checkG1" class="reg-rows">
        ...
        <div class="sub-user" v-if="checkA2">
...
export default {
  ...
  methods: {
    async register () {
      ...
      this.isLoader = true
      if (this.$store.state.role === 'G1' && this.setUser.credit > this.$store.state.auth.creditremain) {
