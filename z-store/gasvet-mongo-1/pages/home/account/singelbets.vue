          ...
          <li class="title-ligth">
            <div class="blinks">
              ...
              <span class="bitems cp">
                <span>
                  <span v-if="!checkA2 && !checkG1">SAHİP</span>
                  <span v-else>
        ...
        <ul class="bet-summary-con po-r">
          <div class="list-bet"  v-for="(list,index) in filterBy(betSummary, searchBox)" :key="index" :class="list.state">
            <li class="blinks"  @click="getBets($event, index, list)">
              ...
              <span class="bitems-list bid" :class="{betIdClass: betSum.sumid === list.sumid}">{{ list.sumid }}</span>
            ...
            <span class="bitems-list bstate">
              ...
              <i class="fas fa-trash-alt bet-cancel" v-if="list.state ==='Aktif' && checkA2" @click="cancelBet($event, list.id, list.amount, list.user,index)" />
                ...
                <div class="bet-con">
                  <ul>
                    <li class="title-ligth">
                      ...
                      <span v-if="checkA2 || checkS3 || checkB4" class="bitems bstate">DURUM</span>
                    </li>
                  </ul>
                  <ul class="bet-details po-r">
                    <li class="list-bet details-list"  v-for="(list,index) in bets" :key="index" :class="{innerAktif:list.state === 'Aktif',Kazandi:list.state === 'Kazandi', Kaybetti:list.state === 'Kaybetti', iade:list.state === 'iade', iptal:list.state === 'iptal'}">
                      ...
                      <span v-if="checkA2 || checkS3 || checkB4 && list.code !== isBetLoader" class="bitems-list bstate">
                      ...
                      <div id="printMe">
                        <ul class="slip-item-con only-print">
                          <div class="print-title">
                            ...
                            <li class="slip-date">
                              <span class="slip-items">No: {{ list.betid }}</span>
