...
import marketsjson from '~/assets/markets/soccerlivemarkets.json'
  ...
  methods: {
    async getLive() {
      ...
      await axios.get("/api/home/soccerinplay").then((result) => {
        ...
        this.liveList =  this.setGroup(final, 'LeagueId')
        this.search = final
    ...
    searchFilter () {
      ...
      this.liveList = this.setGroup(searchArray, 'leagueid')
