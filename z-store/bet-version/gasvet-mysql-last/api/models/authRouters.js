    ...
    if (result[0].length > 0) {
      ...
      if (req.body.pass === dePass) {
        if (result[0][0].state === 'pasif') {
          ...
          if (result[0][0].role === 'Member' || result[0][0].role === 'Subadmin') {
            role = result[0][0].admin
          }else if(result[0][0].role === 'Submember'){
            role = result[0][0].superadmin
          }else{
            role = result[0][0].user
          }
          if (result[0][0].role === 'Member' || result[0][0].role === 'Submember'|| result[0][0].role === 'Subadmin'){
