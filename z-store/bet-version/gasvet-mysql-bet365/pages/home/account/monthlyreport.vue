    ...
    <div class="bet-con">
      <ul class="bet-summary-con">
        <div>
          <div class="bet-con">
            <ul class="bet-summary-con">
              <li class="set-li set-li-ins"><h3>Aylık Genel Rapor</h3></li>
              ...
              <li class="set-li set-li-ins">
                <i class="fas fa-ban cl-d"/>
                <span class="set-li-item">
                  <span class="stlt">Iptal Kuponlar : </span>
                  <span>{{cancel.count}}</span>
                </span>
                <span class="set-li-item">
                  <span class="stlt">Iptal Miktar : </span>
              ...
              <li class="set-li set-li-ins bg-b">
                <span class="set-li-item">
                  ...
                  <span class="ml20 cl-y">Aktifler Rapor Dışıdır!</span>
                </span>
              </li>
            </ul>
          </div>
  ...
  methods: {
    ...
    async getBetInfo () {
      ...
      await axios.post('/api/home/account/bettotalinfo/',{userbox:this.userBox}).then((result) => {
        ...
        this.cancel = result.data.cancelinfo
        this.loader = false
      })
    }
  }
