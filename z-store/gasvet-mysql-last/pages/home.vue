    ...
    <header class="home-header">
      <div class="home-top-left">
        ...
        <div class="home-top-inside htis">
          ...
          <div class="hhli">
            ...
            <span v-if="checkSubmember" class="cl-g ml5">{{ getEarnSubuser | currency('', 2)}}</span>
      ...
      <div class="home-top-right">
        <div class="home-top-inside htir">
          ...
          <div class="hhli" v-if="$store.state.auth && $store.state.auth.role !== 'Member' && $store.state.auth.role !== 'Submember'">
          ...
          <div class="hhli">
            ...
            <span class="cl-y subcredit" v-if="$store.state.auth.role !== 'Submember' && $store.state.betinfo.subcredit > 0">({{$store.state.betinfo.subcredit | currency('', 0)}})</span>
          </div>
        </div>
