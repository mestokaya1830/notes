...
<!-- Boss-Superadmin section------------------------------- -->
  <span class="hr"></span>
    <section v-if="checkSuperadmin || checkBoss || checkAdmin && users.role === 'Subadmin'">
      ...
      <li class="userdetails-items" v-if="checkSuperadmin || checkBoss">
        <span class="userdetails-text">Ödeme</span>
        <div class="form-rows nick-input">
          <span class="edit-value">{{ users.payment | fullFormat }}</span>
        </div>
        <i class="fa fa-thumbs-up fa-2x cl-g slbs mBoss5" v-if="done === 'payment'"/>
...
<!-- Admin-u1 section------------------------------- -->
    ...
    <section v-if="checkAdmin">
      ...
      <li class="userdetails-items" v-if="users.role === 'Subadmin'">
      ...
      <li class="userdetails-items">
        ...
        <i class="fa fa-thumbs-up fa-2x cl-g slbs mBoss0" v-if="done === 'ucdone'"/>
        <span v-if="errorcredit" class="ml10 cl-r">{{errorcredit}}</span>
      </li>
    </section>
    <section v-if="checkSubadmin">
      <li class="userdetails-items">
        <span class="userdetails-text">Bakiye</span>
