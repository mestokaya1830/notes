    ...
    <div class="odd-center">
      <div class="title-2">
        <section>
          ...
          <i
            class="fas fa-adjust navbar-icons"
...
import marketsjson from "~/assets/markets/basketmarkets.json";
...
export default {
  ...
  mounted() {
    if (!localStorage.getItem("set")) {
      ...
      if (JSON.parse(localStorage.getItem("set")).find((item) => item.filterid === 2)) {
