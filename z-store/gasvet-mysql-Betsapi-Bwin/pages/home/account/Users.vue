  ...
  <div v-if="checkRole" class="pages">
    ...
    <ul>
      <li class="title-ligth">
        ...
        <span v-if="checkU1 || checkA1" class="uitems bitems-title">LİMİT</span>
        <span v-if="checkG1 || checkU1 || checkA1" class="uitems bitems-title">BAKİYE</span>
        <span v-if="checkB1 || checkS1" class="uitems bitems-title">LİMİT</span>
    ...
    <ul class="bet-summary-con-admin">
      <li v-for="list in users" :key="list._user">
        <nuxt-link class="list" :to="'/home/account/users/' + list.user">
          ...
          <span v-if="checkU1 || checkA1" class="uitems-list">{{ list.credit | currency('', 2, { thousandsSeparator: '.' }) }}</span>
          <span v-if="checkG1 || checkU1 || checkA1" class="uitems-list">{{ list.creditremain | currency('', 2, { thousandsSeparator: '.' }) }}</span>
