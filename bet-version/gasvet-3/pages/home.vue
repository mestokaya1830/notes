  ...
  <div class="home-page">
    <header class="home-header">
      <div class="home-top-left">
        <div class="home-top-inside"  v-if="checkS3B4">
        ...
        <div class="home-top-inside htis"  v-if="checkS3B4">
          <div class="hhli">
...
export default {
  ...
  computed:{
    ...
    checkS3B4 (){
      if (this.$store.state.auth.role === 'S3' || this.$store.state.auth.role === 'B4') {
        return false
      }else{
        return true
      }
