@extends('welcome')
@section('content')
<section id="services-08" class="services-08 pt-120 pb-120 p-relative"
      ...
      <div class="col-lg-4 col-md-4">
        <div class="services-08-item">
          ...
          <div class="services-08-content">
            ...
            <p>Donec vestibulum arcu a arcu scelerisque, quis dignissim turpis semper onec tortor mi, volutpat a iaculis
              sit amet.</p>
          </div>
        </div>
      </div>
